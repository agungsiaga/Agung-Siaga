...
<head>
  ...
  <title>Agung Siaga | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/dashboard_as/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="/dashboard_as/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
