        ...
        <div class="tp-banner-container">
            <div class="tp-banner">
                <ul>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><h2 class="medium-title">Support To Accommodate, <br> Feed And Educate.</h2></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><div class="sub-title white-text">Give a helping hand to those who need it. Volunteers do notGive a helping hand to <br> those who need it. Volunteers do not</div></div>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/foto/SE/91815-mesin-cuci-untuk-pengungsi-gunung-agung.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                    <img src="images/foto/SE/91815-mesin-cuci-untuk-pengungsi-gunung-agung.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><div class="sub-title alterternate">Welcome to Agung Siaga!</div></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><div class="sub-title white-text">Give a helping hand to those who need it. Volunteers do notGive a helping hand to <br> those who need i helping hand to those who need it.</div></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><a href="#" class="theme-btn btn-style-one">Learn More</a> &ensp; <a href="#" class="theme-btn btn-style-two">Be with us</a></div>
                    
                    </li>
                    
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/foto/SE/065169100_1506756573-20170930-Gunung-Agung-GM1.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                    <img src="images/foto/SE/065169100_1506756573-20170930-Gunung-Agung-GM1.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
                    ...
                    <div class="fact-counter">
                        <div class="row clearfix">
                            ...
                            <div class="column counter-column wow fadeIn col-md-4 col-sm-6 col-xs-12" data-wow-delay="0ms" data-wow-duration="0ms">
                                <div class="inner">
                                    <div class="icon-box"><span class="icon flaticon-hands-holding-heart"></span></div>
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="4000" data-stop="3500">0</span>
                                    </div>
                                    <h4 class="counter-title">CAUSES SOLVED</h4>
                                </div>
                            </div>
                            ...
                            <div class="column counter-column wow fadeIn col-md-4 col-sm-6 col-xs-12" data-wow-delay="0ms" data-wow-duration="0ms">
                                <div class="inner">
                                    <div class="icon-box"><span class="icon flaticon-hands"></span></div>
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="2000" data-stop="1800">0</span>
                                    </div>
                            ...
                            <div class="column counter-column wow fadeIn col-md-4 col-sm-6 col-xs-12" data-wow-delay="0ms" data-wow-duration="0ms">
                                <div class="inner">
                                    ...
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="1500" data-stop="262">0</span>
                                    </div>
                                    <h4 class="counter-title">TOTAL CAMPAIGNS</h4>
                                </div>
                            </div>
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="text-center">
                    <a href="/campaigns" class="theme-btn btn-style-one view-more">View More</a>
                </div>
            </div>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="column col-md-7 col-sm-6 col-xs-12">
                    <h2>FIND NEAREST POSTS TO DONATE</h2>
                    <div class="text">Let's find nearest post to donate from your location to help the refugees!</div>
                </div>
                <div class="column col-md-5 col-sm-6 col-xs-12 text-right">
                    <form method="GET" action="/map">
                        <div class="form-group">
                            <input id="searchmap" type="text" value="" placeholder="Your Location ..." required>
                            <input id="lat" type="hidden" name="lat" value="" required>
                            <input id="lng" type="hidden" name="lng" value="" required>
                            <button type="submit" class="theme-btn btn-style-one">Find</button>
                        </div>
                    </form>
                </div>
            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <div class="field-inner">
                                            <input type="text" class="donate_form" id="first_name" value="" placeholder="First Name" required>
                                        </div>
                                    </div>
                                    <!--Form Group-->
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <div class="field-inner">
                                            <input type="text" class="donate_form" id="last_name" value="" placeholder="Last Name" required>
                                        </div>
                                    </div>
                                    <!--Form Group-->
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <div class="field-inner">
                                            <input type="email" class="donate_form" id="email" value="" placeholder="Email" required>
                                        </div>
                                    </div>
                                    <!--Form Group-->
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <div class="field-inner">
                                            <input type="text" class="donate_form" id="phone_number" value="" placeholder="Phone Number" required>
                                        </div>
                                    </div>
                                    <!--Form Group-->
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <input class="theme-btn btn-style-one" id="register" type="submit" value="Join Now!">
                                    </div>
                                </div>
                            </div>
                        </div><!--End Donate Form-->
                        ...
                        <div class="footer-widget contact-widget">
                            ...
                            <div class="widget-content">
                                ...
                                <ul class="contact-info">
                                    ...
                                    <li><div class="icon"><span class="flaticon-envelope-1"></span></div>info@Agung Siaga.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget gallery-widget">
                            ...
                            <div class="widget-content">
                                <div class="images-outer clearfix">
                                    <!--Image Box-->
                                    <figure class="image-box"><a href="images/resource/1.jpg" class="lightbox-image" title="Image Title Here" data-fancybox-group="footer-gallery"><img src="images/gallery/1t.jpg" alt=""></a></figure>
                                    <!--Image Box-->
                                    <figure class="image-box"><a href="images/resource/2.jpg" class="lightbox-image" title="Image Title Here" data-fancybox-group="footer-gallery"><img src="images/gallery/2t.jpg" alt=""></a></figure>
                                    <!--Image Box-->
                                    <figure class="image-box"><a href="images/resource/3.jpg" class="lightbox-image" title="Image Title Here" data-fancybox-group="footer-gallery"><img src="images/gallery/3t.jpg" alt=""></a></figure>
                                    <!--Image Box-->
                                    <figure class="image-box"><a href="images/resource/4.jpg" class="lightbox-image" title="Image Title Here" data-fancybox-group="footer-gallery"><img src="images/gallery/4t.jpg" alt=""></a></figure>
                                    <!--Image Box-->
                                    <figure class="image-box"><a href="images/resource/6.jpg" class="lightbox-image" title="Image Title Here" data-fancybox-group="footer-gallery"><img src="images/gallery/6t.jpg" alt=""></a></figure>
                                    <!--Image Box-->
                                    <figure class="image-box"><a href="images/resource/7.jpg" class="lightbox-image" title="Image Title Here" data-fancybox-group="footer-gallery"><img src="images/gallery/7t.jpg" alt=""></a></figure>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.status == 'success'){
                    swal("Successfully registered!", "Check your email for the confirmation!", "success");
                }else{
                    swal("Failed registered!", "Check your data please!", "warning");
                }
            }
        });
    });
