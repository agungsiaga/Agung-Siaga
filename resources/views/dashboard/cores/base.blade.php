...
<head>
  ...
  <title>Agung Siaga | Dashboard</title>
  ...
  <!-- Bootstrap 3.3.7 -->
  <!-- Gmap -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCr2-piW40A6QEcYr6ULvppMvZ6QIg4-84&libraries=places"
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>Agu</b>ng Siaga</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Agu</b>ng Siaga</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="/dashboard_as/fs/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="/panel/administrator">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
        </li>
        <li>
          <a href="/panel/administrator/volunteer">
            <i class="fa fa-users"></i> <span>Volunteer</span>
          </a>
        </li>
        <li>
            <a href="/panel/administrator/bank">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/panel/administrator/list_campaign"><i class="fa fa-circle-o"></i> Lists</a></li>
            <li><a href="/panel/administrator/list_campaign_requested"><i class="fa fa-circle-o"></i> Pending Requests <span class="pull-right-container">
              <small class="label pull-right bg-red">3</small>
            </span></a></li>
          </ul>
        </li>
        <li>
          <a href="/panel/administrator/donation_posts">
            <i class="fa fa-location-arrow"></i> <span>Donation Posts</span>
          </a>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-/dashboard_as"></i> Home</a></li>
