...
class CampaignController extends Controller
{
    ...
    public function uid(){
        return Auth::guard('volunteer')->user()->id;
    }
    ...
    public function dataCampaign(){
        ...
        ->where('tb_campaign.id_volunteer', $this->uid());
    ...
    public function addCampaign(Request $req){
        ...
        $data = array(
            ...
            'id_volunteer' => $this->uid(),
            'description' => $req->input('description'),
            'campaign_name' => $req->input('campaign_name'),
            'campaign_image' => $pic,
            'campaign_thumb' => $this->uploadThumb($pic),
            'target_donation' => $req->input('target_donation'),
            'activate_status' => '0');
        ...
        return redirect('/panel/volunteer')->with($notification);
    }
    ...
    public function deleteProcess($id){
        ...
        if($check_id){
            ...
            if(Campaign::where('id', $id)->where('activate_status', '1')->where('id_volunteer', $this->uid())->count() == 0){
